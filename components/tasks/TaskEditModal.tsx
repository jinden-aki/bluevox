    ...
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center bg-black/40">
      <div className="w-full md:max-w-lg bg-white rounded-t-2xl md:rounded-2xl flex flex-col h-[95vh] md:h-auto md:max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          ...
          <button onClick={onClose} className="text-gray-400 hover:text-ink p-2 min-h-[44px] min-w-[44px] flex items-center justify-center">
        ...
        <div className="flex gap-3 px-5 py-4 border-t border-gray-100 bg-white" style={{ paddingBottom: 'max(1rem, env(safe-area-inset-bottom))' }}>
          <button
            ...
            className="px-4 py-3 text-[13px] text-red-500 border border-red-200 rounded-xl hover:bg-red-50 transition-colors min-h-[44px]"
          >
            削除
          </button>
          <button
            onClick={onClose}
            className="flex-1 py-3 text-[13px] text-gray-600 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors min-h-[44px]"
          >
            キャンセル
          </button>
          <button
            ...
            className="flex-1 py-3 text-[13px] text-white bg-jinden-blue rounded-xl hover:bg-jinden-blue/90 disabled:opacity-40 transition-colors min-h-[44px]"
          >
            {saving ? '保存中...' : '保存'}
          </button>
        </div>
